...
#https://gist.github.com/jpoehls/2406504#file-encoding-helpers-ps1

function Convert-FileEncoding([string]$Include, [string]$Path, [string]$Encoding='UTF8') {
  $count = 0
  Get-ChildItem -Include $Include -Recurse -Path $Path `
  ...
  Write-Output "$count $Include file(s) converted to $Encoding in $Path."
<#
    .SYNOPSIS
...
<#
    .SYNOPSIS
    Returns encoding information of the specified file(s).

    .EXAMPLE
    Get-FileEncoding -Path manifest.psd1

...
Write-Output "`n`tLoading PowerShell `$Profile: AllUsersCurrentHost`n";
...
write-output "`n ** To view cmdlets available in a given module, run: Get-Comand -Module <ModuleName>
";
